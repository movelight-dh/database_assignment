...
( 
	...
	office		varchar2(10),
	constraint 	pk_deparment	primary key(dept_id)		
)
/
...
(
	...
	constraint 	fk_professor	foreign key(dept_id)	references
			department(dept_id)	
)
/
create table course
...
(
	...
	constraint 	fk_class1	foreign key(course_id)	references
			course(course_id),	
	constraint 	fk_class2	foreign key(prof_id)	references
			professor(prof_id)	
)
/
create table takes
(
	...
	constraint 	fk_takes1	foreign key(stu_id)	references
			student(stu_id),	
	constraint 	fk_takes2	foreign key(class_id)	references
			class(class_id)	
)
/
/* 순서대로 레코드 생성 */
...
/
insert into class 
values('C101-01', 'C101', 2012, 1, 'A', '92301', '301호', 40)
/
insert into class 
values('C102-01', 'C102', 2012, 1, 'A', '92001', '209호', 30)
/
insert into class 
values('C103-01', 'C103', 2012, 1, 'A', '92501', '208호', 30)
/
insert into class 
values('C103-02', 'C103', 2012, 1, 'B', '92301', '301호', 30)
/
insert into class 
values('C501-01', 'C501', 2012, 1, 'A', '92501', '103호', 45)
/
insert into class 
values('C501-02', 'C501', 2012, 1, 'B', '92502', '204호', 25)
/
insert into class 
values('C301-01', 'C301', 2012, 1, 'A', '92502', '301호', 30)
/
insert into class 
values('C302-01', 'C301', 2012, 1, 'A', '92501', '209호', 45)
/
insert into class 
values('C502-01', 'C502', 2012, 1, 'A', '92001', '209호', 30)
/
insert into class 
values('C502-02', 'C502', 2012, 1, 'B', '92301', '103호', 26)
/
